...
<title>Tickets issue List</title>
...
try{
	...
	%>
	<div class="smalltext">| 
	<a href="updatebug.jsp?bugid=<%=rs.getString("bugid")%>">Update  Tickets</a> | 
...
<div align="center"><hr width="100" /><a href="admin.jsp"> go to Back</a><hr width="100" /></div>
</td></tr>
